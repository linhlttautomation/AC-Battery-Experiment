...
// add 11/9/15 DBPWM - INMODE
#define INMODE_AFALL_xARISING  0x0000
#define INMODE_AFALL_xBRISING  0x0010
#define INMODE_BFALL_xARISING  0x0020
#define INMODE_BFALL_xBRISING  0x0030

// add 16/9/15 ADCSOCxCTL - ko phai mat na, gia tri so trong datasheet
// bit.TRIGSEL
#define ADC_TRIGS0_SOFT_ONLY 	0x0000
#define ADC_TRIGS1_TIME0_TINT0n 0x0001
#define ADC_TRIGS2_TIME1_TINT1n 0x0002
#define ADC_TRIGS3_TIME1_TINT2n 0x0003
#define ADC_TRIGS4_XINT2_XINT2  0x0004
#define ADC_TRIGS1_EPWM1_SOCA   0x0005
#define ADC_TRIGS5_EPWM1_SOCB   0x0006
#define ADC_TRIGS1_EPWM2_SOCA   0x0007
#define ADC_TRIGS1_EPWM2_SOCB   0x0008
#define ADC_TRIGS1_EPWM3_SOCA   0x0009
#define ADC_TRIGS1_EPWM3_SOCB   0x000A
#define ADC_TRIGS1_EPWM4_SOCA   0x000B
#define ADC_TRIGS1_EPWM4_SOCB   0x000C
#define ADC_TRIGS1_EPWM5_SOCA   0x000D
#define ADC_TRIGS1_EPWM5_SOCB   0x000E
#define ADC_TRIGS1_EPWM6_SOCA   0x000F
#define ADC_TRIGS1_EPWM6_SOCB   0x0010
#define ADC_TRIGS1_EPWM7_SOCA   0x0011
#define ADC_TRIGS1_EPWM7_SOCB   0x0012

// SIMULENx = 0 in reg ADCSAMPLEMODE; bit.CHSEL
#define ADCSOCCTL_SIMUx_0_INA0 0x0000
#define ADCSOCCTL_SIMUx_0_INA1 0x0001
#define ADCSOCCTL_SIMUx_0_INA2 0x0002
#define ADCSOCCTL_SIMUx_0_INA3 0x0003
#define ADCSOCCTL_SIMUx_0_INA4 0x0004
#define ADCSOCCTL_SIMUx_0_INA5 0x0005
#define ADCSOCCTL_SIMUx_0_INA6 0x0006
#define ADCSOCCTL_SIMUx_0_INA7 0x0007
#define ADCSOCCTL_SIMUx_0_INB0 0x0008
#define ADCSOCCTL_SIMUx_0_INB1 0x0009
#define ADCSOCCTL_SIMUx_0_INB2 0x000A
#define ADCSOCCTL_SIMUx_0_INB3 0x000B
#define ADCSOCCTL_SIMUx_0_INB4 0x000C
#define ADCSOCCTL_SIMUx_0_INB5 0x000D
#define ADCSOCCTL_SIMUx_0_INB6 0x000E
#define ADCSOCCTL_SIMUx_0_INB7 0x000F

// add 10/11/15 SCI_CCR - SCI Communication Control Register
#define SCI_CCR_STOP_ONE_BIT 	0x0000
#define SCI_CCR_STOP_TWO_BIT 	0x0080
#define SCI_CCR_PARITY_ODD 		0x0000
#define SCI_CCR_PARITY_EVEN		0x0040
#define SCI_CCR_PARITY_DISA 	0x0000
#define SCI_CCR_PARITY_ENA 		0x0020
#define SCI_CCR_LOOP_BACK_DISA 	0x0000
#define SCI_CCR_LOOP_BACK_ENA 	0x0010
#define SCI_CCR_IDLE_MODE_PRO	0x0000
#define SCI_CCR_ADDR_MODE_PRO	0x0008
#define SCI_CCR_CHAR_LENGTH_8	0x0007
#define SCI_CCR_CHAR_LENGTH_7	0x0006
#define SCI_CCR_CHAR_LENGTH_6	0x0005
#define SCI_CCR_CHAR_LENGTH_5	0x0004
#define SCI_CCR_CHAR_LENGTH_4	0x0003
#define SCI_CCR_CHAR_LENGTH_3	0x0002
#define SCI_CCR_CHAR_LENGTH_2	0x0001
#define SCI_CCR_CHAR_LENGTH_1	0x0000

// add 10/11/15 SCI_CTL1 - SCI Control Register 1
#define SCI_CTL1_RX_ERR_INT_DISA	0x0000
#define SCI_CTL1_RX_ERR_INT_ENA		0x0040
#define SCI_CTL1_SW_RESET			0x0020
#define SCI_CTL1_TXWAKE_NO_SELECT	0x0000
#define SCI_CTL1_TXWAKE_SELECT		0x0008
#define SCI_CTL1_SLEEP_DISA			0x0000
#define SCI_CTL1_SLEEP_ENA			0x0004
#define SCI_CTL1_TXENA_DISA			0x0000
#define SCI_CTL1_TXENA				0x0002
#define SCI_CTL1_RXENA_DISA			0x0000
#define SCI_CTL1_RXENA				0x0001

// add 10/11/15 SCI_CTL2 - SCI Control Register 2
#define SCI_CTL2_TXRDY_FULL			0x0000
#define SCI_CTL2_TXRDY_NEXT_CHAR	0x0080
#define SCI_CTL2_TX_EMPTY			0x0040
#define SCI_CTL2_RX_BK_INT_ENA		0x0002
