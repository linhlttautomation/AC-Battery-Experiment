...
PAGE 0 :
   ...
   RAMD0		   : origin = 0x00BB00, length = 0x000800
   RAMD1		   : origin = 0x00C300, length = 0x000800
   
   RAMLS12345      : origin = 0x008800, length = 0x003300
   
   RAMGS0_1		   : origin = 0x00CB00, length = 0x001500
