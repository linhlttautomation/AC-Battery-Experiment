...
#ifndef F2837xD_EPWM_XBAR_DEFINES_H
#define F2837xD_EPWM_XBAR_DEFINES_H

#define CMPSS_CTRIPH  0
#define CMPSS_CTRIPL  0

#define CMPSS_CTRIPH_OR_CTRIPL  1
#define INPUTXBAR				1
...
//
// AQCSFRC  (Action Qualifier Continuous  S/W)
//

#define AQCSF_DISABLED  	0x0
#define AQCSF_FORCE_LOW     0x1
#define AQCSF_FORCE_HIGH    0x2
